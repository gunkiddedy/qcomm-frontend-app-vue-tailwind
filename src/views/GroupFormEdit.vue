            ...
            <div class="flex lg:flex-row flex-col lg:items-center justify-start">
                ...
                <div class="flex flex-col">
                    <div class="project-title lg:mt-0 mt-2">
                        <span class="text-2xl font-semibold leading-3">Edit Group</span>
                    </div>
                    <div class="">
                        ...
                        <div class="lg:w-1/2 lg:mr-4">
                            ...
                            >
                                ...
                                <option 
                                    ...
                                    :key="i" 
                                    :value="item.name"
                                    :selected="item.name == group.status">
                                    {{ item.name }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="select-file flex items-center justify-start py-4 px-4 mb-4">
                        <button 
                            ...
                            <span class="font-semibold text-white text-sm ml-2 leading-loose">
                                {{ isSubmitting ? 'Processing...' : 'Update Group' }}
                            </span>
                        </button>
                        <button
                            @click="canceling" 
    ...
    methods: {
        ...
        getGroupDetail(){
            ...
            .then((response) => {
                ...
                this.group.title = response.data.data.title;
                this.group.description = response.data.data.description;
                this.group.profilePicture = response.data.data.profilePicture;
                this.group.status = response.data.data.status;
                this.group.userId = response.data.data.userId;
